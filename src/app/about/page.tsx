  ...
  return (
    <div className="text-black bg-white p-6 md:p-24">
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        TSCORPORATE has evolved into a versatile provider of a comprehensive
        suite of services, specializing in outsourcing manpower with a
        performance-driven approach. Our ability to adapt to dynamic
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        been to propel TSCORPORATE toward ever more prosperous milestones. I
        have always envisioned our company as an entity capable of making a
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        is their relentless drive that has earned us the trust and respect of
        industry giants. I am confident that we will continue to grow from
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        building on our strengths and achievements while staying true to our
        core principles. The journey of TSCORPORATE is never-ending, but with
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        reliable supplier of essential outputs that meet societal needs. We
      ...
      <ul className="list-disc list-inside mb-4 md:mb-6">
        ...
        <li>
          a driving force in the industrial and commercial development of
          intended endeavors.
        </li>
      </ul>
      <h2 className="text-xl md:text-2xl font-semibold mt-4 md:mt-8 mb-2 md:mb-4">
      ...
      <ol className="list-decimal list-inside mb-4 md:mb-6">
        ...
        <li>Promote team member growth and employee satisfaction.</li>
        <li>Practice win-win partnerships with our clients.</li>
      ...
      <p className="mb-4 md:mb-6 text-justify">
        ...
        services across various sectors, which has led to the establishment of
      ...
      <ul className="list-disc list-inside mb-4 md:mb-6">
        ...
        <li>
          TS Farm (Teshome Soromessa Farm or TSF): Specializes in agriculture
        ...
        <li>
          ...
          Provides travel and tourism services, arranging client tours.
        </li>
      </ul>
      <p className="text-justify">
        Each of these sister companies is a specialized entity, allowing
        TSCORPORATE to offer a broad range of services to its clients across
        multiple industries.
      </p>
    </div>
  );
