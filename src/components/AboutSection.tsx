...
export default function AboutSection() {
  return (
    <section
      className="bg-white py-10 flex flex-col items-center"
      id="about"
    ...
    >
      <div className="bg-blue-100 rounded-lg lg:rounded-full flex flex-col items-center px-6 py-8 md:flex-row md:h-96 sm:px-9">
        <h2
          id="about-heading"
          className="bg-white rounded-full flex justify-center items-center text-blue-600 md:text-xl font-bold px-4 py-4 text-center md:rounded-l-full md:rounded-r-none md:h-full md:p-12 sm:text-4xl sm:px-6"
        >
          About Company
        </h2>
